 ...
 */
export function getGoogleAuthClient(): any {
  ...
  // environments. The returned object behaves like an OAuth2 client.
 ...
 */
export async function exchangeCodeForToken(auth: any, code: string) {
